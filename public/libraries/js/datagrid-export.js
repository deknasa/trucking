(function($){
    ...
    function toHtml(target, rows,valuesToRemove){
        ...
        fields = fields.filter((i) => (valuesToRemove.indexOf(i) === -1));
    ...
    function toExcel(target, param){
        ...
        if (typeof param == 'string'){
            ...
            rows = param['rows'] || null;
            worksheet = param['worksheet'] || 'Worksheet';
            valuesToRemove = param['valuesToRemove'] || [];
        }
        var dg = $(target);
        ...
        var table = toHtml(target, rows,valuesToRemove);
