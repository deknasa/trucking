...
$(document).ready(function() {
    ...
    // console.log($('a.nav-link.active').parents());
...
$('#search').on('input', function(e) {
    // // let accordions = $('a.collapsible')
    // // accordions.attr('aria-expanded', 'false')
    // // accordions.addClass('collapsed')
    // // console.log(accordions.next().removeClass('in'))
    ...
    if (code === "") {
        ...
        //   console.log('anjay');
        // }
        // $('#' + code).next().attr('aria-expanded','false').addClass('collapsed').removeClass('selected').removeClass('in')
        if ($('#' + test).hasClass("selected") || $('#' + test).hasClass("selected-link")) {
            var prev = $(this).data('val');
            // var attribute = $('#' + prev);
            // // console.log(attribute); 
            // if ($(attribute).hasClass('selected')) {
            //   // console.log("berhasil");
            //   $('#' + prev).removeClass("menu-is-opening menu-open");
            ...
            if (attr != "javascript:void(0)") {
                ...
                // var a = $('#' + test)[0].children[0].addClass("tester");
                // console.log(a);
                if ($('#' + test).parent('.nav-item').hasClass("menu-is-opening menu-open") || $('#' + test).parent('.nav-item').hasClass("menu-open")) {
                    // alert("test");  
