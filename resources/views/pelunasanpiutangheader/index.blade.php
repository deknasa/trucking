            ...
            dropmenuHTML: [{
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('pelunasanpiutangheader.report') }}?id=${selectedId}&printer=reportPrinterBesar`)
                  }
                }
              },
              {
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('pelunasanpiutangheader.report') }}?id=${selectedId}&printer=reportPrinterKecil`)
                  }
                }
              },
                ...
                onClick: () => {
                  if (`{{ $myAuth->hasPermission('approvalbukacetak', 'store') }}`) {
                    ...
                    if (selectedId == null || selectedId == '' || selectedId == undefined) {
                      ...
                      approvalBukaCetak(tglbukacetak,'PELUNASANPIUTANGHEADER',[selectedId]);
                    }
                  }
                }
              },
