...
@push('scripts')
<script>
  function loadJurnalPengeluaranGrid(nobukti) {
    ...
    $("#jurnalPengeluaranGrid")
      .jqGrid({
        datatype: 'local',
        data: [],
        styleUI: 'Bootstrap4',
        iconSet: 'fontAwesome',
        idPrefix: 'jurnalPengeluaranGrid',
        colModel: [{
            label: 'NO BUKTI',
            name: 'nobukti',
          },{
      ...
      .jqGrid('filterToolbar', {
        ...
        beforeSearch: function() {
          ...
          clearGlobalSearch($('#jurnalPengeluaranGrid'))
        },
      })
    ...
    loadClearFilter($('#jurnalPengeluaranGrid'))

    /* Append global search */
    loadGlobalSearch($('#jurnalPengeluaranGrid'))
  }

  function loadJurnalPengeluaranData(id, nobukti) {
    abortGridLastRequest($('#jurnalPengeluaranGrid'))
    $('#jurnalPengeluaranGrid').setGridParam({
