...
<script>
  ...
  $(document).ready(function() {
              ...
              // },
              {
                ...
                onClick: () => {
                  if (`{{ $myAuth->hasPermission('kasgantungheader', 'approvalbukacetak') }}`) {
                    ...
                    approvalBukaCetak(tglbukacetak, 'KASGANTUNGHEADER', selectedRows, selectedbukti);
                  }
                }
              },
            ],
    ...
    function permission() {
      ...
      if (!`{{ $myAuth->hasPermission('kasgantungheader', 'destroy') }}`) {
        $('#delete').attr('disabled', 'disabled')
      }

      if (!`{{ $myAuth->hasPermission('kasgantungheader', 'export') }}`) {
