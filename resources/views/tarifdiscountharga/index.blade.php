...
<script>
    ...
    function selectAllRows() {
        $.ajax({
            ...
            success: (response) => {
                selectedRows = response.data.map((tarifdiscountharga) => tarifdiscountharga.id)
                $('#jqGrid').trigger('reloadGrid')
            }
        })
    }
    ...
    $(document).ready(function() {
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        onClick: () => {
                            ...
                            approvalNonAktif('tarifdiscountharga')
        ...
        function permission() {
            ...
            if (!`{{ $myAuth->hasPermission('tarifdiscountharga', 'approvalnonaktif') }}`) {
