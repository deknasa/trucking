...
<script>
    ...
    $(document).on('click', `#btnPreview`, function(event) {
        ...
        if (dari != '' && sampai != '' && supplierdari != '' && suppliersampai != '') {
            window.open(`{{ route('laporankartuhutangpersupplier.report') }}?dari=${dari}&sampai=${sampai}&supplierdari_id=${supplierdari_id}&suppliersampai_id=${suppliersampai_id}&supplierdari=${supplierdari}&suppliersampai=${suppliersampai}`)
        } else {
