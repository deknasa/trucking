        ...
        <form action="" method="post">
          <div class="modal-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="tgltransaksi" class="form-control datepicker">
              </div>
...
<script>
  ...
  $('#crudForm').find('[name=tgltransaksi]').change(function(event) {
    parameterPengeluaran.tglbukti = this.value;
