                ...
                <form id="crudForm">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-2 col-sm-2 col-form-label mt-2">Periode<span class="text-danger">*</span></label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (!`{{ $myAuth->hasPermission('laporantriptrado', 'report') }}`) {
    ...
    $(document).on('click', `#btnExport`, function(event) {
        ...
        if (dari != '' && sampai != '') {
            ...
            $.ajax({
                url: `${apiUrl}laporantriptrado/export`,
                // url: `{{ route('laporantriptrado.export') }}?sampai=${sampai}&dari=${dari}`,
                type: 'GET',
                data : {
                    dari : dari,
                    sampai : sampai
    ...
    function laporantriptrado(data, detailParams, dataCabang) {
