...
<script>
  ...
  let fieldLengthUrl = "{{ route('orderantrucking.field_length') }}"
  let action = "{{ $action }}"
  let actionUrl = "{{ route('orderantrucking.store') }}"
  let method = "POST"
  let csrfToken = "{{ csrf_token() }}"

  /* Set action url */
  <?php if ($action == 'edit') : ?>
    actionUrl = "{{ route('orderantrucking.update', $orderantrucking['id']) }}"
    method = "PATCH"
  <?php elseif ($action == 'delete') : ?>
    actionUrl = "{{ route('orderantrucking.destroy', $orderantrucking['id']) }}"
    method = "DELETE"
  <?php endif; ?>
