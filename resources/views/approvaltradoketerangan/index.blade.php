...
@include('approvaltradoketerangan._modal')
@push('scripts')
<script>
  let page = 0;
  ...
  $(document).ready(function() {
        ...
        buttons: [{
          ...
          },
          {
            ...
            onClick: () => {
              ...
              editApprovalTradoKeterangan(selectedId)
            }
          },
          {
            id: 'delete',
            ...
            onClick: () => {
              ...
              deleteApprovalTradoKeterangan(selectedId)
            }
          },
        ]
      })
    ...
    if (!`{{ $myAuth->hasPermission('approvaltradoketerangan', 'store') }}`) {
    ...
    if (!`{{ $myAuth->hasPermission('approvaltradoketerangan', 'destroy') }}`) {
