            ...
            item: [{
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('invoicechargegandenganheader.report') }}?id=${selectedId}&printer=reportPrinterBesar`)
                  }
                }
              },
              {
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('invoicechargegandenganheader.report') }}?id=${selectedId}&printer=reportPrinterKecil`)
                  }
                }
              },
          ...
          },
          {
            ...
            onClick: () => {
              ...
              if (selectedId == null || selectedId == '' || selectedId == undefined) {
                ...
                $.ajax({
                  url: `${apiUrl}invoicechargegandenganheader/${selectedId}/export`,
                  type: 'GET',
                  data: {
                    forExport : true,
                    invoicechargegandengan_id: selectedId,
                    export: true
                  },
                  ...
                  success: function(response, status, xhr) {
                    if (xhr.status === 200) {
                      if (response !== undefined) {
                        ...
                        link.download = 'LAPORAN INVOICE CHARGE GANDENGAN' + new Date().getTime() + '.xlsx';
                        link.click();
                      }
                    }
