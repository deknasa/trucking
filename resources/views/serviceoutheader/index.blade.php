            ...
            dropmenuHTML: [{
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('serviceoutheader.report') }}?id=${selectedId}&printer=reportPrinterBesar`)
                  }
                }
              },
              {
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('serviceoutheader.report') }}?id=${selectedId}&printer=reportPrinterKecil`)
                  }
                }
              },
          ...
          },    
          {
            ...
            onClick: () => {
              ...
              if (selectedId == null || selectedId == '' || selectedId == undefined) {
                ...
                window.open(`{{ route('serviceoutheader.report') }}?id=${selectedId}`)
              }
            }
          },
          {
