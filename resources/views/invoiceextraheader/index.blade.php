    ...
    grid.jqGrid({
        ...
        colModel: [{
            ...
            formatter: (value, rowOptions, rowData) => {
              return `<input type="checkbox" name="extraId[]" class="checkbox-jqgrid" value="${rowData.id}" onchange="checkboxHandler(this)">`
            },
          },
          {
            label: 'ID',
                ...
                onClick: () => {
                  if (`{{ $myAuth->hasPermission('invoiceextraheader', 'approvalbukacetak') }}`) {
                    ...
                    if (selectedRows.length < 1) {
                      ...
                      approvalBukaCetak(tglbukacetak, 'INVOICEEXTRAHEADER', selectedRows, selectedbukti);
                    }
                  }
                }
              },
