<?php
if (isset($id)) { ?>
    <table id="kerusakanLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
    <table id="kerusakanLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
  ...
  selector = $(`#kerusakanLookup{{ isset($id) ? $id : null }} `)
  ...
  selector.jqGrid({
    ...
    loadComplete: function(data) {
      ...
      if (data.data.length === 0) {
        ...
        $('#subkerusakanGrid').each((index, element) => {
