<?php
if (isset($id)) { ?>
<table id="penerimaanStokLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
<table id="penerimaanStokLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#penerimaanStokLookup{{ isset($id) ? $id : null }} `)
