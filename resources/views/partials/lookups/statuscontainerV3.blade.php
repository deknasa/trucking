<?php
if (isset($id)) { ?>
    <table id="statuscontainerLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
    <table id="statuscontainerLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#statuscontainerLookup{{ isset($id) ? $id : null }} `)
