<?php
    if (isset($id)) { ?>
<table id="pengeluaranstokdetailLookup<?= $id ?>" class="lookup-grid"></table>
<?php
    } else { ?>
<table id="pengeluaranstokdetailLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#pengeluaranstokdetailLookup{{ isset($id) ? $id : null }} `)
