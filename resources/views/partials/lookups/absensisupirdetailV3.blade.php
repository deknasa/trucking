<?php
if (isset($id)) { ?>
    <table id="absensisupirdetailLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
    <table id="absensisupirdetailLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#absensisupirdetailLookup{{ isset($id) ? $id : null }} `)
