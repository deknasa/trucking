<?php
if (isset($id)) { ?>
  <table id="pengeluarantruckingLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
...
<script>
  ...
  selector = $(`#pengeluarantruckingLookup{{ isset($id) ? $id : null }} `)
    ...
    column = [{
      ...
      },
      {
        ...
        formatter: (value, options, rowData) => {
          ...
          let formattedValue = $(`
                    <div class="badge" style="background-color: ${statusFormat.WARNA}; color: ${statusFormat.WARNATULISAN};">
