<?php
if (isset($id)) { ?>
    <table id="absentradoLookup<?= $id ?>" class="lookup-grid"></table>
<?php
} else { ?>
...
<script>
    ...
    selector = $(`#absentradoLookup{{ isset($id) ? $id : null }} `)
    ...
    onSelectRow: function(id) {
        ...
        if (selectedIndex >= limit) selectedIndex = selectedIndex - limit * (page - 1);
