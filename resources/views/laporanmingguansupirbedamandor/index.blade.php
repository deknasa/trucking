...
<script>
    ...
    $(document).ready(function() {
        ...
        if (!`{{ $myAuth->hasPermission('laporanmingguansupirbedamandor', 'export') }}`) {
    ...
    $(document).on('click', `#btnExport`, function(event) {
        ...
        window.open(
            `{{ route('laporanmingguansupirbedamandor.export') }}?dari=${dari}&sampai=${sampai}&tradodari=${tradodari}&tradodari_id=${tradodari_id}&tradosampai=${tradosampai}&tradosampai_id=${tradosampai_id}`
        )
    ...
    function getCekExport() {
        ...
        return new Promise((resolve, reject) => {
            $.ajax({
                url: `${apiUrl}laporanmingguansupirbedamandor/export`,
                dataType: "JSON",
                headers: {
