...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmitApprovalTanpa').click(function(event) {
      ...
      let approvalSupirTanpaId = form.find('[name=id]').val()
      ...
      switch (action) {
        case 'add':
          method = 'POST'
          url = `${apiUrl}supir/approvalsupirtanpa`
          break;
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}supir/approvalsupirtanpa/${approvalSupirTanpaId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}supir/approvalsupirtanpa/${approvalSupirTanpaId}`
  ...
  function approvalSupirTanpa(id) {
    let form = $('#crudFormApprovalTanpa')
