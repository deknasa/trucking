  ...
  $(document).ready(function() {
    ...
    $('#formRange').submit(function(event) {
      ...
      if ($('#rangeModal').data('action') == 'export') {
        ...
        xhr.open('GET', `{{ config('app.api_url') }}subkelompok/export?${params}`, true)
        ...
        xhr.onload = function(e) {
          if (this.status === 200) {
            if (this.response !== undefined) {
              ...
              link.download = `laporanSubKelompok${(new Date).getTime()}.xlsx`
              link.click()
    ...
    $('#add').click(function() {
      ...
      window.location.href = `{{ route('subkelompok.create') }}?sortname=${sortname}&sortorder=${sortorder}&limit=${limit}`
    })
