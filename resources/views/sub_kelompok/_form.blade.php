          ...
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="id" class="form-control" value="{{ $subKelompok['id'] ?? '' }}" readonly>
              </div>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="kodesubkelompok" class="form-control" value="{{ $subKelompok['kodesubkelompok'] ?? '' }}">
              </div>
            </div>
