...
<script>
    ...
    $(document).on('click', `#btnPreview`, function(event) {
        ...
        if (dari != '' && sampai != '' && supplierdari != '' && suppliersampai != '' && status != '') {
            window.open(`{{ route('laporanpembelian.report') }}?dari=${dari}&sampai=${sampai}&supplierdari=${supplierdari}&suppliersampai=${suppliersampai}&status=${status}`)
        } else {
    ...
    $(document).on('click', `#btnExport`, function(event) {
        ...
        let status= $('#crudForm').find('[name=status]').val()
        if (dari != '' && sampai != '' && supplierdari != '' && suppliersampai != '' && status != '') {
        window.open(`{{ route('laporanpembelian.export') }}?dari=${dari}&sampai=${sampai}&supplierdari=${supplierdari}&suppliersampai=${suppliersampai}&status=${status}`)
        } else {
        showDialog('ISI SELURUH KOLOM')
        }
            })
