      ...
      <div class="card card-primary">
        ...
        <form action="" method="post">
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-10">
                <input type="text" name="id" class="form-control" value="{{ $mekanik['id'] ?? '' }}" readonly>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-md-2 col-form-label">
              ...
              <div class="col-12 col-md-10">
                <input type="text" name="namamekanik" class="form-control" value="{{ $mekanik['namamekanik'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-md-2 col-form-label">
              ...
              <div class="col-12 col-md-10">
                <input type="text" name="keterangan" class="form-control" value="{{ $mekanik['keterangan'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-md-2 col-form-label">
              ...
              <div class="col-12 col-md-10">
                <select name="statusaktif" class="form-control select2bs4">
                        ...
                        <?php foreach ($combo['status'] as $key => $item) { 
                            $selected = @$mekanik['statusaktif'] == $item['id'] ? "selected" : ""
                        ?>
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('mekanik.index') }}" class="btn btn-danger">
