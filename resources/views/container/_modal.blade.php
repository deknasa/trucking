            ...
            <div class="row form-group">
              <div class="col-12 col-md-2">
                <label class="col-form-label">
                  Kode Container <span class="text-danger">*</span>
                </label>
              </div>
              <div class="col-12 col-md-10">
                <input type="text" name="kodecontainer" class="form-control">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-md-2">
...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmit').click(function(event) {
      ...
      switch (action) {
        ...
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}container/${mekanikId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}container/${mekanikId}`
  ...
  `)
    ...
    $('#crudModalTitle').text('Edit Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function deleteContainer(mekanikId) {
    let form = $('#crudForm')
  ...
  `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function viewContainer(mekanikId) {
    ...
    `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('View Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
