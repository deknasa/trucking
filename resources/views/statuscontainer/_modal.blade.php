        ...
        <form action="" method="post">
          <div class="modal-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="kodestatuscontainer" class="form-control">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-sm-3 col-md-2">
...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let statusContainerId = form.find('[name=id]').val()
      ...
      switch (action) {
        ...
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}statuscontainer/${statusContainerId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}statuscontainer/${statusContainerId}`
  ...
  `)
    ...
    $('#crudModalTitle').text('Edit Status Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function deleteStatusContainer(statusContainerId) {
    let form = $('#crudForm')
  ...
  `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Status Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function viewStatusContainer(statusContainerId) {
    ...
    `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('View Status Container')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function getMaxLength(form) {
    if (!form.attr('has-maxlength')) {
      return new Promise((resolve, reject) => {
        $.ajax({
          url: `${apiUrl}statuscontainer/field_length`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
            'Authorization': `Bearer ${accessToken}`
  ...
  function showStatusContainer(form, statusContainerId) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}statuscontainer/${statusContainerId}`,
        method: 'GET',
  ...
  function showDefault(form) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}statuscontainer/default`,
        method: 'GET',
        dataType: 'JSON',
        headers: {
          Authorization: `Bearer ${accessToken}`
