      ...
      <div class="card card-primary">
        ...
        <form action="" method="post">
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-4">
                <input type="text" name="nobukti" class="form-control" value="{{ $hutang['nobukti'] ?? '-' }}" readonly>
              </div>
              <div class="col-12 col-md-2 col-form-label">
              ...
              <div class="col-12 col-md-4">
                @php 
                if (isset($hutang['tglbukti'])) {
                $tglbukti = date('d-m-Y',strtotime($hutang['tglbukti']));
                } else {
                $tglbukti = date('d-m-Y');
                }
                @endphp
              ...
              <div class="col-12 col-md-10">
                <select name="pelanggan_id" class="form-control select2bs4">
                  ...
                  <?php foreach ($combo['pelanggan'] as $key => $item) {
                    $selected = @$hutang['pelanggan_id'] == $item['id'] ? "selected" : ""
                  ?>
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-10">
                <input type="text" name="keterangan" class="form-control" value="{{ $hutang['keterangan'] ?? '' }}">
              </div>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-4">
                @php
                if (isset($hutang['tgllunas'])) {
                $tgllunas = date('d-m-Y',strtotime($hutang['tgllunas']));
                } else {
                $tgllunas = date('d-m-Y');
                }
                @endphp
              ...
              <div class="col-12 col-md-10">
                <select name="cabang_id" class="form-control select2bs4">
                  ...
                  <?php foreach ($combo['cabang'] as $key => $item) {
                    $selected = @$hutang['cabang_id'] == $item['id'] ? "selected" : ""
                  ?>
              ...
              <div class="col-12 col-md-10">
                <select name="statuskas" class="form-control select2bs4">
                  ...
                  <?php foreach ($combo['statuskas'] as $key => $item) {
                    $selected = @$hutang['statuskas'] == $item['id'] ? "selected" : ""
                  ?>
              ...
              <div class="col-12 col-md-10">
                <select name="bank_id" class="form-control select2bs4">
                  ...
                  <?php foreach ($combo['bank'] as $key => $item) {
                    $selected = @$hutang['bank_id'] == $item['id'] ? "selected" : ""
                  ?>
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-10">
                <input type="text" name="noresi" class="form-control" value="{{ $hutang['noresi'] ?? '' }}">
              </div>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-bindkeys">
                    ...
                    <tbody id="table_body" class="form-group">
                      @if (isset($hutang['hutangdetail']))
                      @foreach($hutang['hutangdetail'] as $hutangIndex => $d)
                      <tr id="row">

                        <td>
                          <div class="baris">{{ $hutangIndex+1 }}</div>
                        </td>
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('hutang.index') }}" class="btn btn-danger">
...
<script>
  var baris = 1;
  @if(isset($hutang['hutangdetail']))
  baris = "{{count($hutang['hutangdetail'])}}";
  @endif;
  ...
  let indexUrl = "{{ route('hutang.index') }}"
  let action = "{{ $action }}"
  let actionUrl = "{{ config('app.api_url') . 'hutang' }}"
  let method = "POST"
