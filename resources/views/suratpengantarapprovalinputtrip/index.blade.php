...
@include('suratpengantarapprovalinputtrip._modal')
...
<script>
  ...
  $(document).ready(function() {
    ...
    if (!`{{ $myAuth->hasPermission('suratpengantarapprovalinputtrip', 'store') }}`) {
    ...
    if (!`{{ $myAuth->hasPermission('suratpengantarapprovalinputtrip', 'destroy') }}`) {
