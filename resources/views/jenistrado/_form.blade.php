      ...
      <div class="card card-primary">
        ...
        <form action="" method="post">
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="id" class="form-control" value="{{ $jenistrado['id'] ?? '' }}" readonly>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-sm-3 col-md-2 col-form-label">
                <label>
                  KODE JNS TRADO <span class="text-danger">*</span>
                </label>
              </div>
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="kodejenistrado" class="form-control" value="{{ $jenistrado['kodejenistrado'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-sm-3 col-md-2 col-form-label">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="keterangan" class="form-control" value="{{ $jenistrado['keterangan'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('jenistrado.index') }}" class="btn btn-danger">
...
<script>
  ...
  let fieldLengthUrl = "{{ route('jenistrado.field_length') }}"
  let action = "{{ $action }}"
  let actionUrl = "{{ route('jenistrado.store') }}"
  let method = "POST"
  let csrfToken = "{{ csrf_token() }}"

  /* Set action url */
  <?php if ($action == 'edit') : ?>
    actionUrl = "{{ route('jenistrado.update', $jenistrado['id']) }}"
    method = "PATCH"
  <?php elseif ($action == 'delete') : ?>
    actionUrl = "{{ route('jenistrado.destroy', $jenistrado['id']) }}"
    method = "DELETE"
  <?php endif; ?>
