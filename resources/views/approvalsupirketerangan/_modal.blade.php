...
<script>
  ...
  function createApprovalSupirKeterangan() {
    let form = $('#crudForm')
  ...
  `)
    ...
    $('#crudModalTitle').text('Create Approval Supir Keterangan')
  ...
  function deleteApprovalSupirKeterangan(approvalSupirKeteranganId) {
    let form = $('#crudForm')
