...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnSubmit').click(function(event) {
            ...
            switch (action) {
                ...
                case 'edit':
                    method = 'PATCH'
                    url = `${apiUrl}toemail/${Id}`
                    break;
                case 'delete':
                    method = 'DELETE'
                    url = `${apiUrl}toemail/${Id}?tgldariheader=${tgldariheader}&tglsampaiheader=${tglsampaiheader}&indexRow=${indexRow}&limit=${limit}&page=${page}`
                    break;
                default:
                    method = 'POST'
                    url = `${apiUrl}toemail`
    ...
    function getMaxLength(form) {
        if (!form.attr('has-maxlength')) {
            $.ajax({
                url: `${apiUrl}toemail/field_length`,
                method: 'GET',
                dataType: 'JSON',
                headers: {
                    'Authorization': `Bearer ${accessToken}`
