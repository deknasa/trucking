            ...
            dropmenuHTML: [{
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('serviceinheader.report') }}?id=${selectedId}&printer=reportPrinterBesar`)
                  }
                }
              },
              {
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('serviceinheader.report') }}?id=${selectedId}&printer=reportPrinterKecil`)
                  }
                }
              },
          ...
          },
          {
            ...
            onClick: () => {
              ...
              if (selectedId == null || selectedId == '' || selectedId == undefined) {
                ...
                window.open(`{{ route('serviceinheader.report') }}?id=${selectedId}`)
              }
            }
          },
          {
          ...
          dropmenuHTML: [
            {
              ...
              text: "un/Approval Buka Cetak SERVICEIN",
              onClick: () => {
                if (`{{ $myAuth->hasPermission('approvalbukacetak', 'store') }}`) {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    approvalBukaCetak(tglbukacetak,'SERVICEINHEADER',[selectedId]);
                  }
                }
              }
            },
