    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [{
            ...
            formatter: (value, rowOptions, rowData) => {
              return `<input type="checkbox" name="rekappenerimaanId[]" value="${rowData.id}" onchange="checkboxHandler(this)">`
            },
          }, {
            label: 'ID',
            name: 'id',
            ...
            dropmenuHTML: [{
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('rekappenerimaanheader.report') }}?id=${selectedId}&printer=reportPrinterBesar`)
                  }
                }
              },
              {
                ...
                onClick: () => {
                  ...
                  if (selectedId == null || selectedId == '' || selectedId == undefined) {
                    ...
                    window.open(`{{ route('rekappenerimaanheader.report') }}?id=${selectedId}&printer=reportPrinterKecil`)
                  }
                }
              },
        ...
        extndBtn: [{
          ...
          dropmenuHTML: [{
            ...
            },
            {
              ...
              text: "un/Approval Buka Cetak REKAP PENERIMAAN",
              onClick: () => {
