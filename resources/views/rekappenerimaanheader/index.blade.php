    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [{
            ...
            formatter: (value, rowOptions, rowData) => {
              return `<input type="checkbox" name="rekappenerimaanId[]" class="checkbox-jqgrid" value="${rowData.id}" onchange="checkboxHandler(this)">`
            },
          }, {
            label: 'ID',
            name: 'id',
          ...
          },
          {
            ...
            dropmenuHTML: [{
              ...
              },
              {
                ...
                text: "Approval Kirim berkas REKAP PENERIMAAN",
                onClick: () => {
                  if (`{{ $myAuth->hasPermission('rekappenerimaanheader', 'approvalkirimberkas') }}`) {
                    ...
                    if (selectedRows.length < 1) {
                      ...
                      approvalKirimBerkas(tglkirimberkas, 'REKAPPENERIMAANHEADER', selectedRows, selectedbukti);
                    }
                  }
                }
              },
