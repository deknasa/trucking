...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let zonaId = form.find('[name=id]').val()
  ...
  `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Zona')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
