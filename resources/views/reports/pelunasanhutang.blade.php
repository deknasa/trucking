...
<head>
  ...
  <title>Report Pelunasan Hutang</title>
  ...
  <script type="text/javascript">
    let pelunasanhutangheader = <?= json_encode($pelunasanhutang); ?>;
    ...
    function Start() {
      ...
      var statuscetak = pelunasanhutangheader.statuscetak_id
      var sudahcetak = pelunasanhutangheader['combo']['id']
      ...
      if (printer['tipe'] == 'reportPrinterBesar') {
        report.loadFile(`{{ asset('public/reports/ReportPelunasanHutangBesar.mrt') }}`)
      } else {
        report.loadFile(`{{ asset('public/reports/ReportPelunasanHutang.mrt') }}`)
      }

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'pelunasanhutang_details': <?= json_encode($pelunasanhutang_details); ?>,
        'pelunasanhutang': <?= json_encode($pelunasanhutang); ?>
      })
      ...
      window.addEventListener('beforeunload', function() {
        if (window.opener && !window.opener.closed) {
          ...
          var id = pelunasanhutangheader.id
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}pelunasanhutangheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
