...
<head>
  ...
  <title>Laporan Pemutihan Supir</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
      ...
      dataSet.readJson({
        'pemutihanSupir': <?= json_encode($pemutihanSupir); ?>,
        'pemutihanSupir_detail': <?= json_encode($pemutihanSupir_detail); ?>
      })
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}pemutihansupir/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
