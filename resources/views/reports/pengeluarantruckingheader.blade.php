...
<head>
  ...
  <script type="text/javascript">
    ...
    let pengeluarantruckings = <?= json_encode($data); ?>

    console.log(pengeluarantruckings.statuscetak)
    $( document ).ready(function() {
      var statuscetak = pengeluarantruckings.statuscetak
      if (statuscetak == 174) {
    ...
    function Start() {
      ...
      dataSet.readJson({
        'pengeluarantrucking': <?= json_encode($pengeluarantrucking_details); ?>,
