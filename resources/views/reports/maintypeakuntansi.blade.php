...
<head>
  ...
  <title>Laporan Main Tipe Akuntansi</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
     ...
     //  options.appearance.fullScreenMode = true
      ...
      report.loadFile(`{{ asset('public/reports/ReportMainTypeAkuntansi.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'maintypeakuntansi': <?= json_encode($maintypeakuntansi); ?>,
      })
