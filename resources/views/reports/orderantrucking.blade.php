...
<head>
  ...
  <title>Laporan Orderan Trucking</title>
  ...
  <script type="text/javascript">
    ...
    let orderantrucking = <?= json_encode($orderantrucking); ?>
    ...
    function Start() {
      ...
      var statuscetak = orderantrucking.statuscetak_id
      var sudahcetak = orderantrucking['combo']['id']
      ...
      report.loadFile(`{{ asset('public/reports/ReportOrderanTrucking.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'orderantrucking': <?= json_encode($orderantrucking); ?>,
