...
<head>
  ...
  <title>Laporan Proses Uang Jalan Supir</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
      ...
      dataSet.readJson({
        'uangjalansupir': <?= json_encode($uangjalansupir); ?>,
        'uangjalansupir_detail': <?= json_encode($uangjalansupir_detail); ?>
      })
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}prosesuangjalansupirheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
