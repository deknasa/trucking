...
<head>
  ...
  <title>Report Proses Gaji Supir</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
      ...
      report.loadFile(`{{ asset('public/reports/ReportProsesGajiSupir.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'prosesgajisupir': <?= json_encode($prosesgajisupir); ?>,
        'prosesgajisupir_detail': <?= json_encode($prosesgajisupir_detail); ?>
      })
