...
<head>
  ...
  <title>Report Hutang Extra</title>
    ...
    function Start() {
     ...
     //  options.appearance.fullScreenMode = true
      ...
      if (printer['tipe'] == 'reportPrinterBesar') {
        report.loadFile(`{{ asset('public/reports/ReportHutangExtraBesar.mrt') }}`)
      } else {
        report.loadFile(`{{ asset('public/reports/ReportHutangExtra.mrt') }}`)
      }
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}hutangextraheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
