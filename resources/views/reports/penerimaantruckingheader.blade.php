...
<head>
  ...
  <title>Laporan Penerimaan Trucking</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
      ...
      var statuscetak = penerimaantruckings.statuscetak_id
      var sudahcetak = penerimaantruckings['combo']['id']
      ...
      report.loadFile(`{{ asset('public/reports/ReportPenerimaanTruckingHeader.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'penerimaantrucking_details': <?= json_encode($penerimaantrucking_details); ?>,
        'penerimaantrucking': <?= json_encode($penerimaantrucking); ?>
      })
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}penerimaantruckingheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
