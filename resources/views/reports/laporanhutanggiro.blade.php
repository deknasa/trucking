...
<head>
    ...
    <title>Laporan Hutang Giro</title>
    ...
    <script type="text/javascript">
        ...
        function Start() {
            ...
            if (cabang['cabang'] == 'MEDAN') {
                report.loadFile(`{{ asset('public/reports/ReportHutangGiroA4.mrt') }}`)
            } else if (cabang['cabang'] == 'MAKASSAR') {
                report.loadFile(`{{ asset('public/reports/ReportHutangGiroLetter.mrt') }}`)
            } else {
