...
<head>
  ...
  <title>Laporan Absensi Supir Approval</title>
  ...
  <script type="text/javascript">
    let absensiappheader = <?= json_encode($absensiappheader); ?>;
    ...
    function Start() {
      ...
      var statuscetak = absensiappheader.statuscetak_id
      var sudahcetak = absensiappheader['combo']['id']
      ...
      dataSet.readJson({
        'absensiappheader': <?= json_encode($absensiappheader); ?>,
        'absensiappheader_details': <?= json_encode($absensiappheader_details); ?>
      })
      ...
      window.addEventListener('afterprint', (event) => {
        ...
        $.ajax({
          url: `${apiUrl}absensisupirapprovalheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
