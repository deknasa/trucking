...
<head>
  ...
  <title>Laporan Tarif Discount Harga</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
     ...
     //  options.appearance.fullScreenMode = true
      ...
      report.loadFile(`{{ asset('public/reports/ReportTarifDiscountHarga.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'tarifdiscounthargas': <?= json_encode($tarifdiscounthargas); ?>,
      })
