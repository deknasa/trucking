...
<head>
  ...
  <title>Laporan Pengeluaran Trucking</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
     ...
     //  options.appearance.fullScreenMode = true
      ...
      report.loadFile(`{{ asset('public/reports/ReportPengeluaranTrucking.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'pengeluaranTrucking': <?= json_encode($pengeluaranTruckings); ?>,
      })
