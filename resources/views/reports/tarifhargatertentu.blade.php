...
<head>
  ...
  <title>Laporan Tarif Harga Tertentu</title>
  ...
  <script type="text/javascript">
    ...
    function Start() {
     ...
     //  options.appearance.fullScreenMode = true
      ...
      report.loadFile(`{{ asset('public/reports/ReportTarifHargaTertentu.mrt') }}`)

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'tarifhargatertentus': <?= json_encode($tarifhargatertentus); ?>,
      })
