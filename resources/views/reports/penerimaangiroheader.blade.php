...
<head>
  ...
  <title>Laporan Penerimaan Giro</title>
  ...
  <script type="text/javascript">
    let penerimaangiro = <?= json_encode($penerimaangiro); ?>;
    ...
    function Start() {
      ...
      var statuscetak = penerimaangiro.statuscetak_id
      var sudahcetak = penerimaangiro['combo']['id']
      ...
      if (printer['tipe'] == 'reportPrinterBesar') {
        report.loadFile(`{{ asset('public/reports/ReportPenerimaanGiroBesar.mrt') }}`)
      } else {
        report.loadFile(`{{ asset('public/reports/ReportPenerimaanGiro.mrt') }}`)
      }

      report.dictionary.dataSources.clear()

      dataSet.readJson({
        'penerimaangiro': <?= json_encode($penerimaangiro); ?>,
        'penerimaangiro_details': <?= json_encode($penerimaangiro_details); ?>
      })
