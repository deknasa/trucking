...
<head>
  ...
  <script type="text/javascript">
    let invoiceextra = <?= json_encode($invoiceextra); ?>;
    ...
    function Start() {
      ...
      var statuscetak = invoiceextra.statuscetak_id
      var sudahcetak = invoiceextra['combo']['id']
      ...
      if (printer['tipe'] == 'reportPrinterBesar') {
        report.loadFile(`{{ asset('public/reports/ReportInvoiceExtraBesar.mrt') }}`)
      } else {
      ...
      dataSet.readJson({
        'invoiceextra': <?= json_encode($invoiceextra); ?>,
        'invoiceextra_details': <?= json_encode($invoiceextra_details); ?>
      })
