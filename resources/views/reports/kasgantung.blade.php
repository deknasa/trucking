...
<head>
  ...
  <title>Laporan Kas Gantung</title>
  ...
  <script type="text/javascript">
    let kasgantung = <?= json_encode($kasgantung); ?>;
    ...
    function Start() {
      ...
      var statuscetak = kasgantung.statuscetak_id
      var sudahcetak = kasgantung['combo']['id']
      ...
      if (printer['tipe'] == 'reportPrinterBesar') {
        report.loadFile(`{{ asset('public/reports/ReportKasGantungBesar.mrt') }}`)
      } else {
      ...
      dataSet.readJson({
        'kasgantung': <?= json_encode($kasgantung); ?>,
        'kasgantung_details': <?= json_encode($kasgantung_details); ?>
      })
