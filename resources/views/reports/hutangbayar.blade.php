...
<head>
  ...
  <script type="text/javascript">
    ...
    let hutangbayarheader = <?= json_encode($hutangbayar); ?>
    ...
    function Start() {
      ...
      var statuscetak = hutangbayarheader.statuscetak_id
      var sudahcetak = hutangbayarheader['combo']['id']
