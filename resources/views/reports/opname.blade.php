...
<head>
 ...
 <script type="text/javascript">
    ...
    function Start() {
      ...
      var statuscetak = opnameHeader.statuscetak_id
      var sudahcetak = opnameHeader['combo']['id']
     ...
     //  options.appearance.fullScreenMode = true
      ...
      dataSet.readJson({
        'opname': <?= json_encode($opname); ?>,
        'opname_details': <?= json_encode($opname_details); ?>
      })
      ...
      window.addEventListener('afterprint', (event) => {
        var id = opnameHeader.id
        var apiUrl = `{{ config('app.api_url') }}`;
        $.ajax({
          url: `${apiUrl}opnameheader/${id}/printreport`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
