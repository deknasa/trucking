...
<head>
  ...
  <title>Laporan Pengeluaran Bank</title>
    ...
    function Start() {
      ...
      if (cabang['cabang'] == 'PUSAT') {
        if (printer['tipe'] == 'reportPrinterBesar') {
          report.loadFile(`{{ asset('public/reports/ReportPengeluaranBankBesarPusat.mrt') }}`)
        } else {
          report.loadFile(`{{ asset('public/reports/ReportPengeluaranBankPusat.mrt') }}`)
        }
      } else {
        if (printer['tipe'] == 'reportPrinterBesar') {
          report.loadFile(`{{ asset('public/reports/ReportPengeluaranBankBesar.mrt') }}`)
        } else {
          report.loadFile(`{{ asset('public/reports/ReportPengeluaranBank.mrt') }}`)
        }
      }
