...
<script>
    ...
    $(document).ready(function() {
        $('#btnSubmit').click(function(event) {
            ...
            let url
            let form = $('#crudForm')
            let otobonId = form.find('[name=id]').val()
    ...
    function createOtobon() {
        ...
        $('#crudModalTitle').text('Create Otobon')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function editOtobon(Id) {
        ...
        $('#crudModalTitle').text('Edit Otobon')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function deleteOtobon(Id) {
        ...
        `)
        form.find(`.sometimes`).hide()
        $('#crudModalTitle').text('Delete Otobon')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function viewOtobon(Id) {
        ...
        form.find('#btnSubmit').html(`
            ...
            `)
        form.find(`.sometimes`).hide()
        $('#crudModalTitle').text('View Otobon')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function getMaxLength(form) {
        if (!form.attr('has-maxlength')) {
            $.ajax({
                url: `${apiUrl}otobon/field_length`,
                method: 'GET',
                dataType: 'JSON',
                headers: {
                    'Authorization': `Bearer ${accessToken}`
    ...
    function showOtobon(form, otobonId) {
