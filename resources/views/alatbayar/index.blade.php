...
<script>
    ...
    function selectAllRows() {
        $.ajax({
            ...
            success: (response) => {
                selectedRows = response.data.map((alatbayar) => alatbayar.id)
                $('#jqGrid').trigger('reloadGrid')
            }
        })
    }
            ...
            .customPager({
                ...
                modalBtnList: [{
                    ...
                    item: [{
                            ...
                            hidden: (!`{{ $myAuth->hasPermission('alatbayar', 'approvalaktif') }}`),
                            onClick: () => {
                                if (`{{ $myAuth->hasPermission('alatbayar', 'approvalaktif') }}`) {
                                    approvalAktif('alatbayar')
                        ...
                        },
                        {
                            ...
                            hidden: (!`{{ $myAuth->hasPermission('alatbayar', 'approvalnonaktif') }}`),
                            onClick: () => {
                                if (`{{ $myAuth->hasPermission('alatbayar', 'approvalnonaktif') }}`) {
                                    approvalNonAktif('alatbayar')
                                }
                            }
                        },
                    ],
