...
<script>
    ...
    function createApprovalTradoGambar() {
        let form = $('#crudForm')
        ...
        $('#crudModalTitle').text('Create Approval Trado Gambar')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function editApprovalTradoGambar(Id) {
        let form = $('#crudForm')
        ...
        form.find(`.sometimes`).show()
        $('#crudModalTitle').text('Edit Approval Trado Gambar')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
        ...
        Promise
            .all([
                ...
                showApprovalTradoGambar(form, Id)
                    .then(() => {
                        $('#crudModal').modal('show')
                    })
                    .finally(() => {
    ...
    function deleteApprovalTradoGambar(Id) {
        let form = $('#crudForm')
        ...
        form.find(`.sometimes`).show()
        $('#crudModalTitle').text('Delete Approval Trado Gambar')
        $('.is-invalid').removeClass('is-invalid')
        $('.invalid-feedback').remove()
    ...
    function showApprovalTradoGambar(form, Id) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: `${apiUrl}approvaltradogambar/${Id}`,
                method: 'GET',
                dataType: 'JSON',
                headers: {
                    Authorization: `Bearer ${accessToken}`
