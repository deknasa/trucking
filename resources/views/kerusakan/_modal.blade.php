...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let kerusakanId = form.find('[name=id]').val()
      ...
      switch (action) {
        ...
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}kerusakan/${kerusakanId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}kerusakan/${kerusakanId}`
  ...
  function editKerusakan(kerusakanId) {
    let form = $('#crudForm')
  ...
  `)
    ...
    $('#crudModalTitle').text('Edit Kerusakan')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function deleteKerusakan(kerusakanId) {
    let form = $('#crudForm')
  ...
  `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Kerusakan')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function getMaxLength(form) {
    if (!form.attr('has-maxlength')) {
      ...
      $.ajax({
        url: `${apiUrl}kerusakan/field_length`,
        method: 'GET',
        dataType: 'JSON',
        headers: {
          'Authorization': `Bearer ${accessToken}`
  ...
  function showKerusakan(form, kerusakanId) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}kerusakan/${kerusakanId}`,
        method: 'GET',
