...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnSubmit').click(function(event) {
            ...
            switch (action) {
                ...
                case 'edit':
                    method = 'PATCH'
                    url = `${apiUrl}ccemail/${Id}`
                    break;
                case 'delete':
                    method = 'DELETE'
                    url = `${apiUrl}ccemail/${Id}?tgldariheader=${tgldariheader}&tglsampaiheader=${tglsampaiheader}&indexRow=${indexRow}&limit=${limit}&page=${page}`
                    break;
                default:
                    method = 'POST'
                    url = `${apiUrl}ccemail`
    ...
    function cekValidasi(Id, Aksi) {
        $.ajax({
            url: `{{ config('app.api_url') }}ccemail/${Id}/cekValidasi`,
            method: 'POST',
            dataType: 'JSON',
            beforeSend: request => {
    ...
    function getMaxLength(form) {
        if (!form.attr('has-maxlength')) {
            $.ajax({
                url: `${apiUrl}ccemail/field_length`,
                method: 'GET',
                dataType: 'JSON',
                headers: {
                    'Authorization': `Bearer ${accessToken}`
