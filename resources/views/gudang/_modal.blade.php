...
<script>
  ...
  $(document).ready(function() {
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let gudangId = form.find('[name=id]').val()
  ...
  `)
    ...
    $('#crudModalTitle').text('Edit Gudang')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Gudang')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function viewGudang(gudangId) {
    ...
    `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('View Gudang')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function getMaxLength(form) {
    if (!form.attr('has-maxlength')) {
      ...
      $.ajax({
        url: `${apiUrl}gudang/field_length`,
        method: 'GET',
        dataType: 'JSON',
        headers: {
          'Authorization': `Bearer ${accessToken}`
  ...
  function showGudang(form, gudangId) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}gudang/${gudangId}`,
        method: 'GET',
