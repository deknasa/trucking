...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#jqGrid").jqGrid({
      ...
      .navButtonAdd(pager, {
        ...
        onClickButton: function() {
          ...
          window.location.href = `{{ route('supplier.create') }}?sortname=${sortname}&sortorder=${sortorder}&limit=${limit}`
        }
      })
    ...
    if (!`{{ $myAuth->hasPermission('supplier', 'create') }}`) {
      $('#add').addClass('ui-disabled')
    }

    if (!`{{ $myAuth->hasPermission('supplier', 'edit') }}`) {
      $('#edit').addClass('ui-disabled')
    }

    if (!`{{ $myAuth->hasPermission('supplier', 'delete') }}`) {
