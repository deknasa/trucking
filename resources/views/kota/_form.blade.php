      ...
      <div class="card card-primary">
        ...
        <form action="" method="post">
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="id" class="form-control" value="{{ $kota['id'] ?? '' }}" readonly>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-sm-3 col-md-2 col-form-label">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="kodekota" class="form-control" value="{{ $kota['kodekota'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-12 col-sm-3 col-md-2 col-form-label">
              ...
              <div class="col-12 col-sm-9 col-md-10">
                <input type="text" name="keterangan" class="form-control" value="{{ $kota['keterangan'] ?? '' }}">
              </div>
            </div>
            <div class="row form-group">
              ...
              <div class="col-12 col-md-10">
                <select name="zona_id" class="form-control select2bs4">
                        ...
                        <?php foreach ($combo['zona'] as $key => $item) { 
                            $selected = @$kota['zona_id'] == $item['id'] ? "selected" : ""
                        ?>
              ...
              <div class="col-12 col-md-10">
                <select name="statusaktif" class="form-control select2bs4">
                        ...
                        <?php foreach ($combo['statusaktif'] as $key => $item) { 
                            $selected = @$kota['statusaktif'] == $item['id'] ? "selected" : ""
                        ?>
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('kota.index') }}" class="btn btn-danger">
