...
class PengeluaranTruckingHeaderController extends MyController
{
    ...
    public function report(Request $request)
    {
        ...
        $pengeluarantrucking_detail = Http::withHeaders(request()->header())
            ->withOptions(['verify' => false])
            ->withToken(session('access_token'))
    ...
    public function export(Request $request): void
    {
        ...
        //FETCH HEADER
        $pengeluarantruckings = Http::withHeaders($request->header())
        ->withOptions(['verify' => false])
        ->withToken(session('access_token'))
        ->get(config('app.api_url') .'pengeluarantruckingheader/'.$request->id)['data'];
        ...
        $sheet->setCellValue('A1', 'PENGELUARAN TRUCKING');
        ...
        foreach ($header_columns as $header_column) {
            $sheet->setCellValue('B' . $header_start_row, $header_column['label']);
                ...
                $sheet->setCellValue('C' . $header_start_row++, ': '.$pengeluarantruckings[$header_column['index']]);
        ...
        foreach ($pengeluarantrucking_details as $response_index => $response_detail) {
            ...
            $sheet->setCellValue("C$detail_start_row", $response_detail['penerimaantruckingheader_nobukti']);
