        ...
        switch ($pengeluarantrucking['statusformat']) {
            ...
            case '411':
                ...
                foreach ($pengeluarantrucking_details as $response_index => $response_detail) {
                    ...
                    $sheet->setCellValue("A$detail_start_row", $response_index + 1);
                    $sheet->setCellValue("B$detail_start_row", $response_detail['suratpengantar_nobukti']);
                    $sheet->setCellValue("C$detail_start_row", $response_detail['keterangan']);
                    $sheet->setCellValue("D$detail_start_row", $response_detail['jenisorderan']);
                    $sheet->setCellValue("E$detail_start_row", $response_detail['trado_id']);
                    $sheet->setCellValue("F$detail_start_row", $response_detail['nominaltagih']);
                    $sheet->setCellValue("G$detail_start_row", $response_detail['nominal']);
                    ...
                    $sheet->getStyle("F$detail_start_row:G$detail_start_row")->applyFromArray($style_number)->getNumberFormat()->setFormatCode("#,##0.00");
                    $detail_start_row++;
                }
