...
class ExportPengeluaranBarangController extends MyController
{
    public $title = 'Export Pengeluaran Barang';

    public function index(Request $request)
    {
        $title = $this->title;
        $data = [
            'pagename' => 'Menu Utama Export Pengeluaran Barang',
        ];

        return view('exportpengeluaranbarang.index', compact('title'));
    }
    ...
    public function export(Request $request): void
    {
        ...
        $responses = Http::withHeaders($request->header())
            ...
            ->get(config('app.api_url') . 'exportpengeluaranbarang/export', $detailParams);
        ...
        $sheet->setCellValue('A1', 'LAPORAN PENGELUARAN BULAN '. $monthName.' - '.$yearNum);
        ...
        $filename = 'PENGELUARANBARANG' . date('dmYHis');
