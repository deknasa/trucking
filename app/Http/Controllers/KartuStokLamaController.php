...
class KartuStokLamaController extends MyController
{
    public $title = 'Kartu Stok Lama';

    public function index(Request $request)
    {
        $title = $this->title;
        $data = [
            'pagename' => 'Menu Utama Kartu Stok Lama',
        ];

        return view('kartustoklama.index', compact('title'));
    }
    ...
    public function report(Request $request)
    {
        ...
        $header = Http::withHeaders(request()->header())
            ...
            ->get(config('app.api_url') . 'kartustoklama/report', $detailParams);
        ...
        return view('reports.kartustoklama', compact('data','dataHeader'));
    }
    ...
    //         ->withOptions(['verify' => false])
    //         ->withToken(session('access_token'))
    //         ->get(config('app.api_url') . 'kartustoklama/export', $detailParams);
