...
class SatuanController extends MyController
{
    ...
    public function create(): View
    {
        ...
        return view('satuan.add', compact('title','combo'));
    }
    ...
    public function store(Request $request): Response
    {
        try {
            ...
            $response = Http::withHeaders($this->httpHeaders)
                ->withToken(session('access_token'))
                ->post(config('app.api_url') . 'satuan', $request->all());
    ...
    public function edit($id): View
    {
        ...
        return view('satuan.edit', compact('title', 'satuan','combo'));
    }
    ...
    public function update(Request $request, $id): Response
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->patch(config('app.api_url') . "satuan/$id", $request->all());
    ...
    public function delete($id)
    {
        try {
            ...
            return view('satuan.delete', compact('title', 'satuan','combo'));
        } catch (\Throwable $th) {
    ...
    public function report(Request $request)
    {
        $response = Http::withHeaders($this->httpHeaders)
            ->withOptions(['verify' => false])
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'satuan', $request->all());
        ...
        return view('reports.satuan', compact('satuans'));
    }
}
