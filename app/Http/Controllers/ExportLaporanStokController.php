...
class ExportLaporanStokController extends MyController
{
    public $title = 'Export Laporan Stok';

    public function index(Request $request)
    {
        $title = $this->title;
        $data = [
            'pagename' => 'Menu Utama Export Laporan Stok',
        ];

        return view('exportlaporanstok.index', compact('title'));
    }
    ...
    public function export(Request $request): void
    {
        ...
        //     ->get(config('app.api_url') . 'exportlaporanstok/export', $detailParams);
        ...
        $sheet->setCellValue('A3', 'BULAN '. $monthName.' - '.$yearNum);
        ...
        $filename = 'LAPORANSTOK' . date('dmYHis');
