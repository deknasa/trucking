...
class LaporanHistoryTradoMilikSupirController extends MyController
{
    
    public $title = 'Laporan History Trado Milik Supir';

    public function index(Request $request)
    {
        $title = $this->title;
        return view('laporanhistorytradomiliksupir.index', compact('title'));
    }
    ...
    public function report(Request $request)
    {
        ...
        $header = Http::withHeaders(request()->header())
            ...
            ->get(config('app.api_url') . 'laporanhistorytradomiliksupir/report', $detailParams);
    ...
    public function export(Request $request): void
    {
        ...
        $header = Http::withHeaders(request()->header())
            ->withOptions(['verify' => false])
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'laporanhistorytradomiliksupir/export', $detailParams);
        ...
        foreach ($groupedData as $supir => $row) {
            ...
            foreach ($row as $response_detail) {
                ...
                $sheet->setCellValue("C$detail_start_row", $response_detail['supirbaru']);
                $sheet->setCellValue("D$detail_start_row", $response_detail['supirlama']);
        ...
        $filename = 'LAPORAN HISTORY TRADO MILIK SUPIR' . date('dmYHis');
