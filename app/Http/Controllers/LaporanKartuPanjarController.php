...
class LaporanKartuPanjarController extends MyController
{
    public $title = 'Laporan Kartu Panjar Per Customer';

    public function index(Request $request)
    {
        $title = $this->title;
        $data = [
            'pagename' => 'Menu Utama Laporan Kartu Panjar Per Customer',
        ];
    ...
    public function export(Request $request): void
    {
        ...
        $responses = Http::withHeaders($request->header())
            ->withOptions(['verify' => false])
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'laporankartupanjar/export', $detailParams);
