...
class JenisOrderController extends MyController
{
    public $title = 'JENIS ORDER';
    ...
    public function get($params = [])
    {
        ...
        $response = Http::withHeaders(request()->header())
            ...
            ->get(config('app.api_url') . 'jenisorder', $params);
    ...
    public function store(Request $request): Response
    {
        try {
            ...
            $response = Http::withHeaders($this->httpHeaders)
                ->withToken(session('access_token'))
                ->post(config('app.api_url') . 'jenisorder', $request->all());
    ...
    public function update(Request $request, $id): Response
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->patch(config('app.api_url') . "jenisorder/$id", $request->all());
    ...
    public function destroy($id, Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->delete(config('app.api_url') . "jenisorder/$id", $request->all());
    ...
    public function fieldLength(): Response
    {
        $response = Http::withHeaders($this->httpHeaders)
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'jenisorder/field_length');
    ...
    public function report(Request $request)
    {
        $response = Http::withHeaders($this->httpHeaders)
            ->withOptions(['verify' => false])
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'jenisorder', $request->all());

        $jenisorders = $response['data'];
        ...
        return view('reports.jenisorder', compact('jenisorders'));
    }
