...
{
    public $title = 'TarifDiscountHarga';
    ...
    public function get($params = []): array
    {
        ...
        $response = Http::withHeaders(request()->header())
            ...
            ->get(config('app.api_url') . 'tarifdiscountharga', $params);
    ...
    public function create()
    {
        ...
        return view('tarifdiscountharga.add', compact('title', 'data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->post(config('app.api_url') . 'tarifdiscountharga', $request->all());
    ...
    public function edit($id)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . "tarifdiscountharga/$id");

        $tarifdiscountharga = $response['data'];

        $data['combo'] = $this->combo('entry');

        return view('tarifdiscountharga.edit', compact('title', 'tarifdiscountharga', 'data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->patch(config('app.api_url') . "tarifdiscountharga/$id", $request->all());
    ...
    public function delete($id)
    {
        try {
            ...
            return view('tarifdiscountharga.delete', compact('title', 'tarifdiscountharga', 'data'));
        } catch (\Throwable $th) {
            return redirect()->route('tarifdiscountharga.index');
        }
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->withToken(session('access_token'))
            ->delete(config('app.api_url') . "tarifdiscountharga/$id", $request->all());
    ...
    public function fieldLength()
    {
        $response = Http::withHeaders($this->httpHeader)
            ->withToken(session('access_token'))
            ->get(config('app.api_url') . 'tarifdiscountharga/field_length');
