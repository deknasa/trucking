...
class ProsesUangJalanSupirHeaderController extends MyController
{
    ...
    public function export(Request $request): void
    {
        ...
        $detail_columns = [
            ...
            [
                'label' => 'Tanggal Bukti Penerimaan Trucking',
                'index' => 'penerimaantrucking_tglbukti',
            ],
            [
                'label' => 'Bank Penerimaan Trucking',
            ...
            [
                'label' => 'Tanggal Bukti Pengeluaran Trucking',
                'index' => 'pengeluarantrucking_tglbukti',
            ],
            [
                'label' => 'Bank Pengeluaran Trucking',
            ...
            [
                'label' => 'Tanggal Bukti Pengembalian Kas Gantung',
        ...
        //LOOPING HEADER
        $uangjalansupir['nominaluangjalan'] = number_format((float) $uangjalansupir['nominaluangjalan'], '2', ',', '.');
        ...
        foreach ($uangjalansupir_detail as $response_index => $response_detail) {
            ...
            $sheet->setCellValue("F$detail_start_row", $response_detail['pengeluarantrucking_nobukti']);
            $sheet->setCellValue("G$detail_start_row", $response_detail['pengeluarantrucking_tglbukti']);
            $sheet->setCellValue("H$detail_start_row", $response_detail['pengeluarantrucking_bank_id']);
            $sheet->setCellValue("I$detail_start_row", $response_detail['pengembaliankasgantung_nobukti']);
            $sheet->setCellValue("J$detail_start_row", $response_detail['pengembaliankasgantung_tglbukti']);
            $sheet->setCellValue("K$detail_start_row", $response_detail['pengembaliankasgantung_bank_id']);
            $sheet->setCellValue("L$detail_start_row", $response_detail['statusprosesuangjalan']);
