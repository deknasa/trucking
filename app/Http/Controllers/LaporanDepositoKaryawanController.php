...
class LaporanDepositoKaryawanController extends MyController
{
    public $title = 'Laporan Deposito Karyawan';

    public function index(Request $request)
    {
        $title = $this->title;
        $data = [
            'pagename' => 'Menu Utama Laporan Deposito Karyawan',
        ];

        return view('laporandepositokaryawan.index', compact('title'));
    }
