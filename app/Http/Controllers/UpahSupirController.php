    ...
    public function export(Request $request): void
    {
        ...
        if ($get == null) {
            ...
            foreach ($upahsupir as $response_index => $response_detail) {
                ...
                $sheet->setCellValue("E$detail_start_row", $response_detail['20"_FULL EMPTY'])->getStyle("E$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("F$detail_start_row", $response_detail['20"_FULL'])->getStyle("F$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("G$detail_start_row", $response_detail['20"_EMPTY'])->getStyle("G$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("H$detail_start_row", $response_detail['40"_FULL EMPTY'])->getStyle("H$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("I$detail_start_row", $response_detail['40"_FULL'])->getStyle("I$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("J$detail_start_row", $response_detail['40"_EMPTY'])->getStyle("J$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("K$detail_start_row", $response_detail['2X20"_FULL EMPTY'])->getStyle("K$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("L$detail_start_row", $response_detail['2X20"_FULL'])->getStyle("L$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("M$detail_start_row", $response_detail['2X20"_EMPTY'])->getStyle("M$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("N$detail_start_row", $response_detail['liter20"_FULL EMPTY'])->getStyle("N$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("O$detail_start_row", $response_detail['liter20"_FULL'])->getStyle("O$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("P$detail_start_row", $response_detail['liter20"_EMPTY'])->getStyle("P$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("Q$detail_start_row", $response_detail['liter40"_FULL EMPTY'])->getStyle("Q$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("R$detail_start_row", $response_detail['liter40"_FULL'])->getStyle("R$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("S$detail_start_row", $response_detail['liter40"_EMPTY'])->getStyle("S$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("T$detail_start_row", $response_detail['liter2X20"_FULL EMPTY'])->getStyle("T$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("U$detail_start_row", $response_detail['liter2X20"_FULL'])->getStyle("U$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
                $sheet->setCellValue("V$detail_start_row", $response_detail['liter2X20"_EMPTY'])->getStyle("V$detail_start_row")->getNumberFormat()->setFormatCode('#,##0.00');
